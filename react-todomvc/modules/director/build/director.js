...
(function (exports) {
  ...
  function paramifyString(str, params, mod) {
    mod = str;
    for (var __fromJSForIn3 in f__getForInLoopKeyObject(params)) {
      var param;param = f__getTrackedPropertyName(params, __fromJSForIn3);
  ...
  f__assign(Router.prototype, f__StringLiteral('traverse'), function (method, path, routes, regexp, filter) {
    ...
    for (var __fromJSForIn4 in f__getForInLoopKeyObject(routes)) {
      var r;r = f__getTrackedPropertyName(routes, __fromJSForIn4);
  ...
  f__assign(Router.prototype, f__StringLiteral('mount'), function (routes, path) {
    ...
    for (var __fromJSForIn5 in f__getForInLoopKeyObject(routes)) {
      var route;route = f__getTrackedPropertyName(routes, __fromJSForIn5);
